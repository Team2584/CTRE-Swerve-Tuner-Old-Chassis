...
public class Intake extends SubsystemBase {
  ...
  public boolean hasAlgae() {
    if (inputs.statorCurrent > statorCurrentLimit) {
  ...
  public Command intakeCommand(double percent) {
    return runEnd(() -> io.setVoltage((percent/100)*12), () -> io.setVoltage(0.0)).until(()-> hasAlgae());
  }


  public Command outtakeCommand(double percent) {
    return runEnd(() -> io.setVoltage(-(percent/100)*12), () -> io.setVoltage(0.0));
  }
